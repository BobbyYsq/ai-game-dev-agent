...
- Project-local Git workbench for project-level saves, branch management, merge-to-main, history, safe restore-to-commit, revert commit, and restore-file compatibility actions.
