...
def make_project(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr("app.models.image_provider.load_private_settings", lambda: {"image_provider": "mock"})
    return project


def test_mock_image_generation_creates_manifest(tmp_path, monkeypatch):
